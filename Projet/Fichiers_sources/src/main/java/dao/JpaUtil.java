...
public class JpaUtil {
     ...
     */
    public static final String PERSISTENCE_UNIT_NAME = "dasi_TD_jar_1.0-SNAPSHOTPU";
    /**
    ...
    public static synchronized void creerFabriquePersistance() {
        ...
        emf = Persistence.createEntityManagerFactory(PERSISTENCE_UNIT_NAME,propertyMap);
    }
    ...
    public static void creerContextePersistance() {
        ...
        threadLocalEntityManager.set(emf.createEntityManager());
    }
